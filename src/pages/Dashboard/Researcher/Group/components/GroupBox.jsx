  ...
  useEffect(() => {
    const fetchBoards = async () => {
      const res = await fetch(
        `http://34.126.100.66:8080/boards/get/${selfInfo.groupId}`,
        {
          method: "get",
        }
      );
    ...
    const fetchMember = async () => {
      const res = await fetch(
        `http://34.126.100.66:8080/researcher/getGroupList/${selfInfo.groupId}`,
        {
          method: "get",
        }
      );
    ...
    const fetchRequestExam = async () => {
      const res = await fetch(
        `http://34.126.100.66:8080/requestExam/getRequestGroup/${selfInfo.groupId}`,
        {
          method: "GET",
        }
      );
