...
const GroupDetail = () => {
  ...
  useEffect(() => {
    const fetchBoards = async () => {
      const res = await fetch(`http://34.126.100.66:8080/boards/get/${grpId}`, {
        method: "get",
      });
    ...
    const fetchRequestExam = async () => {
      const res = await fetch(
        `http://34.126.100.66:8080/requestExam/getRequestGroup/${grpId}`,
        {
          method: "GET",
        },
      );
  ...
  const updateBoardSubmitHandler = async () => {
    const res = await fetch("http://34.126.100.66:8080/boards/updateBoard", {
      method: "PUT",
